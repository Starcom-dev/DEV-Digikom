        ...
        <div class="card p-2 mt-5" style="background-color: #fff">
                ...
                <div class="ml-4 mt-4 d-flex justify-content-between" style="width: 100%">
                    ...
                    <div>
                        <button onclick="window.location.href='{{ route('anggota.index') }}'" class="btn btn-primary">←
                            Kembali ke Daftar Anggota</button>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center">
                <div class="mt-2 flex-grow-1 m-2"
                    style="background-color: #e6e6e6; border-radius: 10px; padding: 15px;">
                    ...
                    <table style="font-size: 12px">
                        ...
                        <tr>
                            <td>Pendidikan</td>
                            <td>: {{ $user->pendidikan_id != null ? $user->pendidikan->pendidikan : 'Belum diisi' }}
                            </td>
                        </tr>
                        <tr>
                            <td>Pekerjaan</td>
                ...
                <div class="mt-2 flex-grow-1 m-2"
                    ...
                    <div class="text-center" style="width: 100%">
                        @if ($user->ktp_picture != null)
                            <img src="{{ asset('storage/' . $user->ktp_picture) }}" class="img-thumbnail"
                                style="width: 20rem; height: 10rem; object-fit:cover;" alt="ktp_picture" />
                            <a class="btn btn-sm btn-primary ml-2" href="{{ asset('storage/' . $user->ktp_picture) }}"
                                target="_blank">🔎 Lihat Detail</a>
                        @else
                            <img src="{{ asset('assets/ktp_default.png') }}" class="img-thumbnail"
                                style="width: 20rem; height:10rem;" alt="ktp_picture" />
                        @endif
                    </div>

...
<div class="main-panel">
    <div class="content-wrapper" style="background-color: #D1D1D1;">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="mb-3">
                <button onclick="window.location.href='{{ route('anggaran-dasar') }}'" class="btn btn-primary">
                    ← Kembali ke Anggaran Dasar
                </button>
            </div>
        </div>
        @if ($errors->any())
        ...
        <div class="col grid-margin stretch-card">
            <div class="card" style="background-color: #2A2A2A;">
                <div class="card-body">
                    <form action="{{ route('save-anggaran-dasar') }}" method="POST">
                        @csrf

                        <textarea id="myeditorinstance" name="anggaran_dasar">{{{ $anggaranDasar }}}</textarea>

...
<div class="main-panel">
    <div class="content-wrapper" style="background-color: #D1D1D1;">
        ...
        @endsession
        @if(!$anggaranDasar == '' || !$anggaranDasar == null)
            <div class="col-12 text-right mb-4">
                <a href="{{ route('edit-anggaran-dasar', ['id' => $idOrganisasi]) }}" class="btn btn-sm btn-primary ">Ubah Anggaran Dasar</a>
            </div>
        @endif
            ...
            <div class="card" style="background-color: #2A2A2A;">
                <div class="card-body">
                    <div class="mb-4 text-center">
                        @if ($anggaranDasar == '' || $anggaranDasar == null)
                            <p class="text-muted mt-3">Anggaran Dasar belum di buat.</p>
                            <a href="{{ route('edit-anggaran-dasar') }}" class="btn btn-sm btn-primary ">Buat
                                Sekarang</a>
                        @else
                            <textarea id="myeditorinstance">{{{ $anggaranDasar }}}</textarea>
                        @endif
                    </div>
                </div>
            </div>

...
<div class="main-panel">
    <div class="content-wrapper" style="background-color: #D1D1D1;">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="card-title text-black">Edit Anggaran Rumah Tangga "{{ $anggaran_rumah_tangga->judul_utama }}"</h3>
            <div class="mb-3">
                <button onclick="window.location.href='{{ route('anggaran-rumah-tangga.index') }}'"
        ...
        <div class="col grid-margin stretch-card">
            <div class="card" style="background-color: #2A2A2A;">
                <div class="card-body">
                    <form action="{{ route('anggaran-rumah-tangga.update', $anggaran_rumah_tangga->id) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="judul_utama" class="text-white" style="font-weight: bold;">Judul</label>
                            <input type="text" class="form-control" name="judul_utama" id="judul_utama"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sub_judul" id="sub_judul"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="deskripsi" id="deskripsi" rows="5"
                                ...
                                onfocus="this.style.backgroundColor='#2A3038'; this.style.color='#ffffff';" required>{{ $anggaran_rumah_tangga->deskripsi }}</textarea>
                        </div>

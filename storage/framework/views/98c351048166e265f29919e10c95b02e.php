...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse <?php echo e(request()->is('anggota*') || request()->is('pengurus*') || request()->is('jabatan*') || request()->is('usaha*') || request()->is('pendaftar*') ? 'show' : ''); ?>" id="auth">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('usaha.index')); ?>">Usaha Anggota</a></li>
                  	<li class="nav-item"><a class="nav-link" href="<?php echo e(route('pendaftar')); ?>">Pendaftar</a></li>
                </ul>
            </div>
        </li>
        ...
        <!-- Banner -->
        <li class="nav-item menu-items">
        	<a class="nav-link <?php echo e(request()->is('banner*') ? 'active' : ''); ?>" href="<?php echo e(route('banner.index')); ?>">
                <span class="menu-icon">
                    <i class="mdi mdi-file-document-box"></i>
                </span>
...
<?php /**PATH D:\Belajar\laravel11\laravel_digikom\resources\views/components/sidebar.blade.php ENDPATH**/ ?>
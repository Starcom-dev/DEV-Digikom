                ...
                <div class="card" onclick="redirectToPendaftar()" style="cursor: pointer;">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0 text-success">Pendaftar</h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                    ...
                    <h6 class="text-muted font-weight-normal"><?php echo e($totalPendaftar); ?></h6>
                  </div>
                </div>
              </div>
...
<script>
    ...
    function redirectToBerita() {
  	...
  	function redirectToPendaftar() {
    	window.location.href = "<?php echo e(route('pendaftar')); ?>"
    }
</script>
<?php /**PATH /home/digikom.xyz/laravel/resources/views/index.blade.php ENDPATH**/ ?>